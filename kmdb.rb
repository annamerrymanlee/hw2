...
puts "" # Adds a space before the Top Cast section

# Prints a header for the top cast output
puts "Top Cast"
puts "========"
puts ""

# Query all roles and include associated movie and actor
roles = Role.includes(:movie, :actor).all

# Loop through and display cast members for each movie
roles.each do |role|
